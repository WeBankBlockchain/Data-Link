...
cp dist/Data-Link*.jar ./tools

echo "copy Data-Link.jar success..."

echo "run Data-Link.jar"

java -jar Data-Link*.jar --spring.config.location=./config/application.properties